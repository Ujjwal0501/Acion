...
public class ResultList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(ResultList.this, e+"", Toast.LENGTH_LONG).show();
        }
    }

    public void emptyResult() {
        LinearLayout addView = new LinearLayout(ResultList.this);
    ...
    public void addRow(Cursor mCursor) {
        ...
        LinearLayout addView1 = new LinearLayout(ResultList.this);
